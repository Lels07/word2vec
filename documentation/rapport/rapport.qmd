...
On peut le vérifier algébriquement : en effet notre score est obtenu par le scalaire entre la matrice $\mathcal{W_2} \in \mathbb{R}^{|V| \times n}$ et le vecteur $\widehat{x}$ de taille $n$ on a donc :
$$
\begin{bmatrix}
