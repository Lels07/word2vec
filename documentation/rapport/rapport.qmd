...
![accuracy en fonction du nombre d'epoch sur une liste de tautologie](./img/accuracy_plot.png){#fig-accEpochen}

![accuracy en fonction des epochs pour les sous catégories de tautologie](./img/accuracy_subtype_en.png){#fig-subaccEpochen}
